...
\begin{itemize}
    \item Istruzione aritmetico/logica \lstinline{add dest, reg1, reg2}
        \begin{figure}[h]
            \centering
...
lenta, dato che il tempo di esecuzione di ogni istruzione necessita di essere pari al tempo di esecuzione dell'istruzione più lenta.
