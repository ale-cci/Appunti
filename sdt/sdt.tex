...
\begin{itemize}
    \item TDD: Non ottimale per un alto traffico in rete
    \item OFDMA: \textit{Orthogonal Frequency Division Multiple Acces}
\end{itemize}
...
Assegna gruippi di sottoportanti dell'OFDM agli utenti, basandosi su quanto BitRate richiedono gli utenti.
