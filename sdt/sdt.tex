...
\begin{itemize}
    \item Utilizza OFDM (\textit{Orthogonal Frequency Division Multiplexing}) per il downlink e Single-Carrier FDMA per l'uplink (al posto del W-CDMA)
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/sdt/arch_lte}
