...
\begin{figure}[h]
    \includegraphics[width=0.8\textwidth]{comp_ftcdma}
    \centering
...
\begin{wrapfigure}{R}{0.3\textwidth}
    \includegraphics[width=0.3\textwidth]{distanza_riuso}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=0.4\textwidth]{bts_interferenti}
    \centering
...
\begin{figure}[h]
\includegraphics[width=0.7\textwidth]{gprs}
\centering
...
\begin{figure}[h]
\includegraphics[width=0.8\textwidth]{architettura_utran}
\centering
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=0.7\textwidth]{umts_cn}
    \centering
...
% image 1
\begin{figure}[h]
    \includegraphics[width=0.5\textwidth]{eutran}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=0.8\textwidth]{Evolved_Packet_Core}
    \centering
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=0.8\textwidth]{ofdm_transmitter}
    \centering
...
\begin{wrapfigure}{R}{0.5\textwidth}
    \includegraphics[width=0.5\textwidth]{ofdm-subcarriers}
    \centering
